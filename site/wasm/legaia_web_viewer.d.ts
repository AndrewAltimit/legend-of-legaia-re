 ...
 * `{ data, summary, seed }`.
 */
export function patch_rom(image: Uint8Array, seed: string, drops: string, encounters: string, chests: string, steals: string, doors: string, door_coupling: string, house_doors: string): any;
...
export interface InitOutput {
    ...
    readonly patch_rom: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number, q: number, r: number) => [number, number, number];
