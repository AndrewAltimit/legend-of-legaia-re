...
export const legaiaviewer_current_tim_clut_count: (a: number) => number;
export const legaiaviewer_current_tim_count: (a: number) => number;
export const legaiaviewer_current_tim_index: (a: number) => number;
export const legaiaviewer_current_tim_info_json: (a: number) => [number, number];
...
export const legaiaviewer_set_tim_in_entry: (a: number, b: number) => [number, number];
