...
# @runtime Jython
#
# Dumps functions from the debug menu overlay (overlay_debug_menu.bin).
# Captured from Duckstation save state save 6 (debug/dev menu) via extract-duckstation-overlay.py.
#
# Debug/dev menu -- full superset of the fishing overlay (154/156 prologues shared). Adds 12 debug-menu-specific functions. Contains "DEBUG MODE" dispatcher, minigame selector (FISH/TEST/MUSIC/PACHI/BOKO/MINI BATTLE/DANCE), FOG/MAP/TMD/POLY debug readouts. Most comprehensive capture of the xxx_dat / other_game overlay family.
#
# Run against the named overlay program:
#   docker compose exec -T ghidra /ghidra/support/analyzeHeadless \
#       /projects legaia -process overlay_debug_menu.bin -noanalysis \
#       -postScript /scripts/dump_debug_menu_overlay.py
#
# Output files land in /scripts/funcs/overlay_debug_menu_<addr>.txt
...
TARGETS = [
    ...
    "801d74b0",  # FUN_801d74b0, inc=6, sz=120
    "801d7bb8",  # FUN_801d7bb8, inc=6, sz=120
    "801cffdc",  # FUN_801cffdc, inc=5, sz=76
    ...
    "801d0230",  # FUN_801d0230, inc=2, sz=384
    "801d6f90",  # FUN_801d6f90, inc=2, sz=160
    "801d0100",  # FUN_801d0100, inc=2, sz=152
    "801d73b8",  # FUN_801d73b8, inc=2, sz=152
    ...
    "801d4004",  # FUN_801d4004, inc=1, sz=1708
    ...
    "801d0474",  # FUN_801d0474, inc=1, sz=496
    ...
    "801d0198",  # FUN_801d0198, inc=1, sz=152
    ...
    "801d746c",  # FUN_801d746c, inc=1, sz=68
    "801d84b4",  # FUN_801d84b4, inc=1, sz=68
    "801d0070",  # FUN_801d0070, inc=1, sz=24
    ...
    "801ce97c",  # FUN_801ce97c, inc=0, sz=2492
    ...
    "801d0f5c",  # FUN_801d0f5c, inc=0, sz=1172
    ...
    "801cf338",  # FUN_801cf338, inc=0, sz=1016
    ...
    "801d092c",  # FUN_801d092c, inc=0, sz=784
    ...
    "801d06c8",  # FUN_801d06c8, inc=0, sz=612
    ...
    "801cfee0",  # FUN_801cfee0, inc=0, sz=252
    ...
    "801cf730",  # FUN_801cf730, inc=0, sz=204
    ...
    "801cfcdc",  # FUN_801cfcdc, inc=0, sz=156
    ...
    "801cfd84",  # FUN_801cfd84, inc=0, sz=124
    ...
    "801cfe20",  # FUN_801cfe20, inc=0, sz=60
    "801cfe5c",  # FUN_801cfe5c, inc=0, sz=60
    "801f1c88",  # FUN_801f1c88, inc=0, sz=40
    "801f1cb0",  # FUN_801f1cb0, inc=0, sz=40
    "801f1d20",  # FUN_801f1d20, inc=0, sz=40
    "801cfe98",  # FUN_801cfe98, inc=0, sz=36
    "801cfebc",  # FUN_801cfebc, inc=0, sz=36
    "801cfe00",  # FUN_801cfe00, inc=0, sz=32
