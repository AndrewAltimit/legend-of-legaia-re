...
# @runtime Jython
#
# Dumps functions from the dance overlay (overlay_dance.bin).
# Captured from Duckstation save state save 4 (Disco King / dance minigame) via extract-duckstation-overlay.py.
#
# Dance minigame (Disco King). FUN_801d2f38 (18 callers, 960 bytes) is the main step-input handler. Shares 132/164 prologues with fishing. Replaces the partial overlay_0978_other_game.bin capture.
#
# Run against the named overlay program:
#   docker compose exec -T ghidra /ghidra/support/analyzeHeadless \
#       /projects legaia -process overlay_dance.bin -noanalysis \
#       -postScript /scripts/dump_dance_overlay.py
#
# Output files land in /scripts/funcs/overlay_dance_<addr>.txt
...
TARGETS = [
    ...
    "801d3fd0",  # FUN_801d3fd0, inc=13, sz=112
    "801d63b0",  # FUN_801d63b0, inc=10, sz=208
    "801e9b3c",  # FUN_801e9b3c, inc=8, sz=208
    "801d32f8",  # FUN_801d32f8, inc=4, sz=528
    "801d03c4",  # FUN_801d03c4, inc=4, sz=500
    "801d1960",  # FUN_801d1960, inc=4, sz=404
    "801e3764",  # FUN_801e3764, inc=4, sz=304
    "801e3658",  # FUN_801e3658, inc=4, sz=268
    "801e3894",  # FUN_801e3894, inc=4, sz=240
    "801d3d78",  # FUN_801d3d78, inc=4, sz=176
    "801ed710",  # FUN_801ed710, inc=3, sz=2032
    "801d2524",  # FUN_801d2524, inc=3, sz=1260
    "801db8ec",  # FUN_801db8ec, inc=3, sz=308
    "801eca08",  # FUN_801eca08, inc=3, sz=256
    "801d3e28",  # FUN_801d3e28, inc=3, sz=152
    ...
    "801d0190",  # FUN_801d0190, inc=1, sz=564
    "801d231c",  # FUN_801d231c, inc=1, sz=520
    "801dd310",  # FUN_801dd310, inc=1, sz=436
    "801d2d98",  # FUN_801d2d98, inc=1, sz=416
    "801e7448",  # FUN_801e7448, inc=1, sz=404
    "801da390",  # FUN_801da390, inc=1, sz=396
    "801d1820",  # FUN_801d1820, inc=1, sz=320
    ...
    "801d67f0",  # FUN_801d67f0, inc=0, sz=972
    "801e4d8c",  # FUN_801e4d8c, inc=0, sz=968
    "801d2a10",  # FUN_801d2a10, inc=0, sz=904
    "801f811c",  # FUN_801f811c, inc=0, sz=896
    "801d6bbc",  # FUN_801d6bbc, inc=0, sz=852
    "801d3a2c",  # FUN_801d3a2c, inc=0, sz=844
    ...
    "801d76e0",  # FUN_801d76e0, inc=0, sz=480
    "801d387c",  # FUN_801d387c, inc=0, sz=432
    ...
    "801d7a5c",  # FUN_801d7a5c, inc=0, sz=348
    ...
    "801d6480",  # FUN_801d6480, inc=0, sz=252
    ...
    "801d6660",  # FUN_801d6660, inc=0, sz=176
    "801ecd0c",  # FUN_801ecd0c, inc=0, sz=168
    "801d6310",  # FUN_801d6310, inc=0, sz=160
    "801d6f90",  # FUN_801d6f90, inc=0, sz=160
    "801ddf48",  # FUN_801ddf48, inc=0, sz=156
    "801d73b8",  # FUN_801d73b8, inc=0, sz=152
    ...
    "801d6770",  # FUN_801d6770, inc=0, sz=128
    ...
    "801d657c",  # FUN_801d657c, inc=0, sz=124
    "801d7964",  # FUN_801d7964, inc=0, sz=124
    ...
    "801d4098",  # FUN_801d4098, inc=0, sz=68
    ...
    "801d6300",  # FUN_801d6300, inc=0, sz=16
]
