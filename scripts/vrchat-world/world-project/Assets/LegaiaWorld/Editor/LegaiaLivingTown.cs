...
namespace LegaiaWorld
{
    ...
    public static class LegaiaLivingTown
    {
            ...
            string sceneName, LegaiaLivingTownOptions o, LegaiaSceneSettings settings)
        {
            ...
            // wrong side of a wall), a home is only ever assigned to a
            // villager who can walk or hop to its door, and an outdoor
            // stand spot no villager can reach is rejected (s_reachFrom)
            // instead of being walked at until the walk times out.
