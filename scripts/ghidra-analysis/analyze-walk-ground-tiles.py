...
USAGE
    scripts/ghidra-analysis/analyze-walk-ground-tiles.py captures/ram_dumps/mountain_walk.bin
    scripts/ghidra-analysis/analyze-walk-ground-tiles.py DUMP --verify-rule WALK.MAP
...
import gpu_packets  # shared PSX GPU primitive decode (scripts/ghidra-analysis/gpu_packets.py)
