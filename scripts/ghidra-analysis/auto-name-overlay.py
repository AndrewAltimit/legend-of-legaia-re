...
What it does:
  ...
  2. Extracts the overlay window 0x801C0000..0x80200000 (256 KiB) using
     the same anchor-string approach as scripts/ghidra-analysis/extract-mednafen-overlay.py.
...
Usage:
    scripts/ghidra-analysis/auto-name-overlay.py SAVE
    scripts/ghidra-analysis/auto-name-overlay.py SAVE --label custom_name
    scripts/ghidra-analysis/auto-name-overlay.py SAVE --out-dir /tmp --force
...
# @runtime Jython
#
# Auto-generated stub by scripts/ghidra-analysis/auto-name-overlay.py.
#
...
def main() -> int:
    ...
    print()
    print("Next:")
    print(f"  scripts/ghidra-analysis/import-overlay-named.sh {bin_path} {label}")
