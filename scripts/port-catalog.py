...
Usage:
    ...
    python3 scripts/port-catalog.py --dashboard           # open-work rollup (single page)
...
def render_dashboard(
    ...
    lines: list[str] = [
        ...
        "",
        "Regenerated by `scripts/port-catalog.py --dashboard`. Cross-references:",
        "",
        ...
        "- [`scripts/features.toml`](../../scripts/features.toml) — feature definitions (roots + stop_at boundaries).",
        "- [`scripts/port-catalog-ignore.toml`](../../scripts/port-catalog-ignore.toml) — addresses excluded from the port worklist.",
        "",
        "## Global",
        "",
    ]
    ...
    if features:
        ...
        lines.extend(
            [
                "## Per-feature status",
                "",
                "_No features defined in `scripts/features.toml`._",
                "",
            ]
        )
    ...
    if ignored_rows:
        ...
        lines.extend(
            [
                "## Ignore-list summary",
                "",
                "Addresses explicitly out of scope for engine porting — statically-linked PsyQ / BIOS / SDK code mapped to native equivalents (Rust stdlib, wgpu, cpal). Source: [`scripts/port-catalog-ignore.toml`](../../scripts/port-catalog-ignore.toml).",
                "",
                "| Category | Count |",
                "|---|---:|",
            ]
