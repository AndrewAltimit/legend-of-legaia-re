...
Usage:
    python3 scripts/ci/function-coverage.py              # text report
    python3 scripts/ci/function-coverage.py --json       # machine-readable
    python3 scripts/ci/function-coverage.py --top 30     # top-N missing helpers
    python3 scripts/ci/function-coverage.py --overlay-breakdown  # per-overlay stats
    python3 scripts/ci/function-coverage.py --graph citations.dot  # Graphviz DOT
    python3 scripts/ci/function-coverage.py --stale      # dump files never cited
"""
