...
| Confuse | `5` | 3 turns | Acts uncontrollably / random target | a confused physical strike (monster *or* party) retargets to a random living member of the opposite side (`FUN_801E7320`); a confused party member auto-acts with no command menu. Confused casts are a follow-up |
