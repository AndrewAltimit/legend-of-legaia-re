...
| [Item-effect descriptor table](item-effect-table.md) | Static `SCUS_942.54` table (`DAT_800752C0`, 130 records, 4-byte stride), indexed item id → subtype → `[class, tier, flags, 'A']`. Effect class + tier + all-party/field/battle usability flags; literal restore amounts are overlay-resident, not here. |
