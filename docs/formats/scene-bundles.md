...
- **Some dungeon scenes carry the whole asset table *inside* their `scene_v12_table` entry**, at file offset `0x1000` - not as a first-class `SceneAssetTable` / `SceneScriptedAssetTable` sibling.
  ...
  `rikuroa` (v12 entry 164, MAN 39508 B, partitions `[18, 70, 20]`) and `dolk2` (v12 entry 76, MAN 2345 B, partitions `[10, 7, 3]`) reach their MAN only this way. Full byte table + provenance: [`scene-v12-table.md`](scene-v12-table.md#embedded-man-bearing-asset-table-v12-family-dungeon-bundles). Disc-gated coverage: `crates/engine-core/tests/v12_bundle_man_disc.rs`.
