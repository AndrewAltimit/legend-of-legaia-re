...
| `0x8007B9B8` | One-shot latch gating the field init's slot-10 load (raw `0x428` then `0x422`) together with track `0x814` at `0x8007BAC8` (`0x801D71A0..0x801D7274`). Unmodelled. |
