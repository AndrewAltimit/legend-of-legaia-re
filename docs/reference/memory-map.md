...
| `0x8007BACC` | u32 | No writer of any of the five reference forms. It gates a recentre-window form that is consequently unreachable. |
| `0x8007B76C` | u32 | The sibling of `0x8007BACC` on the same unreachable path, and likewise unwritten. |
