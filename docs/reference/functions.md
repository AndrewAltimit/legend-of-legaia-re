...
| `80047430` | Battle actor-update routine. Sets `actor[+0x16e] |= 0x380` (the AI-controlled flag that gates the `monster_setup`/`FUN_801E7320` call) when the monster record's flags dword at record `+0x00` has bit `0x2000`. `80047430.txt`. |
