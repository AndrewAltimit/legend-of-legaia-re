...
The capture probe is ready: `scripts/pcsx-redux/autorun_super_art_queue_builder.lua` watches `*(0x8007BD24)+0x274` for writes; it needs a PCSX-Redux battle save taken at a Super/Miracle Art combo commit (runbook: [`docs/tooling/super-art-queue-capture.md`](../tooling/super-art-queue-capture.md)).
