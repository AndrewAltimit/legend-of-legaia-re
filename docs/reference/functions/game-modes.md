...
| `801DE37C` | **Field draw-context primer** (PROT 0897, 100 B). Seeds the scratchpad draw context `0x1F800314` and the three-word block at `0x8008+0x40B8` with `(0, 0x200, 0x4000)`, then writes the `0x1B8` screen constant to `0x8008-0x4870`. `overlay_field_0897_801de37c.txt`. |
