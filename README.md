...
- **[`docs/reference/`](docs/reference/)** - [key Ghidra-traced functions](docs/reference/functions.md), [RAM map + globals](docs/reference/memory-map.md), [TCRF region data](docs/reference/builds.md), [curated game-data tables](docs/reference/gamedata.md), [open RE threads](docs/reference/open-rev-eng-threads.md) (the live hunts), [settled threads](docs/reference/re-settled-threads.md) (the answers, each with an evidence grade), and [do not re-walk](docs/reference/re-do-not-re-walk.md) (falsified hypotheses worth not re-deriving).
