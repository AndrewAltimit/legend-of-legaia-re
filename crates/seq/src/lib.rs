        ...
        for ev in &self.events {
            match &ev.body {
                EventBody::Channel { message, .. } => match message {
                    ...
                    ChannelMessage::ChannelAftertouch { .. } => s.channel_aftertouch += 1,
                    ChannelMessage::PolyAftertouch { .. } => s.poly_aftertouch += 1,
                },
...
pub struct EventSummary {
    ...
    pub pitch_bend: u32,
    pub channel_aftertouch: u32,
    pub poly_aftertouch: u32,
    pub set_tempo: u32,
    pub time_sig: u32,
