...
impl Gte {
    ...
    fn rtps_inner(&mut self, vertex: GteVec3) -> ScreenXY {
        ...
        // REF: gte_divide - Unsigned Newton-Raphson reciprocal + near-camera
        // overflow clamp (see crate::gte::math). MAC1/MAC3 are held here in
        // q19.12 (4096x the hardware IR/SZ scale), so reduce to the hardware
        // IR1/IR2 numerator and SZ3 depth with the same >>12 the SZ FIFO push
        // uses below before feeding the divide.
