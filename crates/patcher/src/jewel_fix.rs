...
//! |---|---|---|
//! | PROT 944 | Guilty Cross `0x37` (Curse All `0x53` shares the module; its dispatched tick has no damage call) | Cort (humanoid phases) |
...
/// PROT entry (extraction index) of the Guilty Cross cast module (shared with
/// Curse All, whose dispatched tick carries no damage call)
