...
//!
//! ```text
//! cargo run -p legaia-patcher --example overlay_slice_bin -- <input.bin> <output.bin>
//! ```
//!
...
//! sentinel `0x5E2D7ADE` to RAM `0x8007AF20` (`legaia_patcher::seru_overlay::{SENTINEL,
...
fn main() -> Result<()> {
    ...
    use legaia_patcher::seru_overlay as ov;
