...
//! slice of a fled fight's experience into the party (see `legaia_patcher::flee_exp`).
//!
...
//! only in memory. NB the engine can't run injected MIPS, so unlike
