...
use legaia_patcher::map_door::MapDoorClass;
...
fn shuffle_map_doors_round_trips_on_disc() {
    ...
    for r in &report.rewires {
        ...
        let sd = legaia_patcher::map_door::SceneMapDoors::locate(&entry, r.entry_idx)
        ...
        if checked_scenes.insert(r.entry_idx) {
            ...
            let base_sd = legaia_patcher::map_door::SceneMapDoors::locate(&base_entry, r.entry_idx)
