...
(`0` = vanilla Healing Leaf ×5; capped at 5, or 3 with `--all-warps`).
`--door-of-wind` adds the Door of Wind warp consumable to the starting bag, and
