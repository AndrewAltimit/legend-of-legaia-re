...
/// real gear, not a quest item. A few priced-but-special tools (e.g. the Silver
/// Compass, which a shop sells) are not caught here; the curated
/// [`crate::items::DEFAULT_STATIC_CHEST_ITEMS`] covers those, and
/// [`crate::items::default_static_chest_items`] unions the two.
///
