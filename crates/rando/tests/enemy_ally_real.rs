...
fn composes_with_flee_exp_in_the_same_gap() {
    ...
    apply::inject_flee_exp(&mut patcher, legaia_rando::flee_exp::DEFAULT_PCT).expect("flee");
    ...
    assert_eq!(
        scus_words(&scus, legaia_rando::flee_exp::ROUTINE_VA, 4)[0],
        legaia_rando::flee_exp::assemble_routine(legaia_rando::flee_exp::DEFAULT_PCT)[0],
